...
namespace DA_Assets.FCU
{
    ...
    internal class FcuSettingsWindow : DAInspectorWindow<FcuSettingsWindow, FcuEditor, FigmaConverterUnity>
    {
            ...
            gui.DrawGroup(new Group
            {
                ...
                Body = () =>
                {
                    ...
                    gui.DrawGroup(new Group
                    {
                        ...
                        {
                            gui.Space10();
                            gui.Label10px(FcuLocKey.label_alpha_version.Localize(), widthType: WidthType.Expand);
                        }
                    });
        ...
        internal AssetTab AssetTab => assetTab.Bind(this, monoBeh);

        private FontsTab fontsTab;
        internal FontsTab FontsTab => fontsTab.Bind(this, monoBeh);

        private MainSettingsTab mainSettingsTab;
        internal MainSettingsTab MainSettingsTab => mainSettingsTab.Bind(this, monoBeh);

        private UnityComponentsTab unityComponentsTab;
        internal UnityComponentsTab UnityComponentsTab => unityComponentsTab.Bind(this, monoBeh);

        private FigmaComponentsTab figmaComponentsTab;
        internal FigmaComponentsTab FigmaComponentsTab => figmaComponentsTab.Bind(this, monoBeh);

        private ImportEventsTab importEventsTab;
        internal ImportEventsTab ImportEventsTab => importEventsTab.Bind(this, monoBeh);

        private DebugToolsTab debugToolsTab;
        internal DebugToolsTab DebugToolsTab => debugToolsTab.Bind(this, monoBeh);

        private DependenciesTab dependenciesTab;
        internal DependenciesTab DependenciesTab => dependenciesTab.Bind(this, monoBeh);

        private PrefabSettingsTab prefabSettingsTab;
        internal PrefabSettingsTab PrefabSettingsTab => prefabSettingsTab.Bind(this, monoBeh);
    }
