...
{
    internal class DALocalizator<T> : SingletoneScriptableObject<T> where T : ScriptableObject
    {
        ...
        internal string Localize(string key, Language lang, params object[] args)
        {
