...
namespace DA_Assets.FCU.Extensions
{
    public static class AutoLayoutExtensions
    {
        ...
        {
            string aligment = "";
            aligment += fobject.PrimaryAxisAlignItems != null ? fobject.PrimaryAxisAlignItems : "NULL";
            aligment += " ";
            aligment += fobject.CounterAxisAlignItems != null ? fobject.CounterAxisAlignItems : "NULL";

            switch (aligment)
            {
                case "NULL NULL":
                    return TextAnchor.UpperLeft;
                case "SPACE_BETWEEN NULL":
        ...
        {
            if (fobject.PrimaryAxisAlignItems == "SPACE_BETWEEN")
            {
