        ...
        public IEnumerator GenerateSprites(List<FObject> fobjects)
        {
            ...
            DACycles.ForEach(generative, fobject =>
            {
                ...
                try
                {
                    ...
                    if (hasStrokes && fobject.StrokeAlign != "OUTSIDE")
                    {
                        ...
                        if (hasFills && hasStrokes)
                        {
                            textureColor = solidStroke.Color;
                        }
                        else
                        {
                            textureColor = Color.white;
                    ...
                    monoBeh.Log($"GenerateSprites | {fobject.Data.Hierarchy} | hasFills: {hasFills} | hasStrokes: {hasStrokes}", FcuLogType.Default);
